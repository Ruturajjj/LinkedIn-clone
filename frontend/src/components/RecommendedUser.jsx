...
const RecommendedUser = ({user}) => {
    ...
    const renderButton = ()=>{
        if(isLoading){
            return(
                <button className='px-3 py-1 rounded-full text0sm bg-gray-200 text-gray-500' disabled>
                    Loading...
                </button>
            )
        }
            ...
            case "received":
                ...
                <div className='flex gap-2 justify-center'>
                    <button onClick={()=> acceptRequest(connectionStatus.data.requestId)}
                        className={`rounded-full p-1 flex items-center justify-center bg-green-500 hover:bg-green-600
                        text-white`}>
                            <Check size={16}/>
                        ...
                        className={`rounded-full p-1 flex items-center justify-center bg-red-500 hover:bg-red-600
                        text-white`}>
                            <X size={16}/>
                        </button>
                </div>
             ...
             case "connected":
                ...
                default:
                    return(
                        ...
                        hover:text-white transition-colors duration-200 flex items-center' onClick={handleConnect}>
