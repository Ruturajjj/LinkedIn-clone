  ...
  <div className="bg-secondary rounded-lg shadow mb-4 p-4">
    ...
    <div className="flex justify-between items-center mt-4">
        <div className="flex space-x-4">
            <label className='flex items-center text-info hover:text-info-dark transition-colors duration-200
            cursor-pointer'>
        ...
        transition-colors duration-200' onClick={handlePostCreation} disabled={isPending}>
